...
export const SITE = {
  ...
  description:
    "Hernando.ia — Projetos, automações e conteúdos sobre inteligência artificial na prática. Um espaço para testar, construir e compartilhar IA de forma simples.",
  keywords: [
  ...
  author: {
    ...
    jobTitle: "Criador do Hernando.ia",
    sameAs: [
