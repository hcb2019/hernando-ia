      ...
      <main className="relative">
        ...
        <section className="relative pt-32 pb-20 px-6 sm:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <a
                href="#comprar"
                className="inline-flex items-center gap-3 bg-[--accent] text-[--accent-foreground] font-bold uppercase tracking-tighter px-10 py-5 text-base transition-all hover:scale-105 active:scale-95 sm:text-lg"
              >
                QUERO MINHAS SKILLS
                <svg
                  className="h-5 w-5"
        ...
        >
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a
              href="#"
              className="inline-flex items-center gap-3 bg-[--accent] text-[--accent-foreground] font-bold uppercase tracking-tighter px-12 py-6 text-lg transition-all hover:scale-105 active:scale-95"
            >
              COMPRAR AGORA — R$97
              <svg
                className="h-5 w-5"
